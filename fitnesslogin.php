...
$sql="INSERT INTO `fitnesslogin`.`fitnesslogin` (  `email`, `password`) VALUES (  '$email', '$password');";
...
<body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" >
	        <ul  class="navbar-nav ml-auto">
	        	<li class="nav-item "><a href="index.html" class="nav-link">Home</a></li>  <!--active yahan iss liyh use hua hai taky home page py home blue color ka ho jaye or under line bhi blue ho jaye as active show ho -->
	        	<li class="nav-item"><a href="signup.html" class="nav-link">Sign Up</a></li>
	        	<li class="nav-item active"><a href="login.html.html" class="nav-link">Login</a></li>
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn  "name=" btnwc1">
							Login
						</button>
					</div>
	...
	<footer class="footer">
	  ...
	  <div class="col-md-6 col-lg-8">
		...
		<p class="copyright">
Copyright &copy; We completed this project together hope u'll like it MAAM HIRA &#128512  by <a href="#" target="_blank"><br> FAIZ20sw039/&#128521 <br>FIZA20sw063/&#128522<br> SHIZA20sw024/ &#128524<br>RABIYA20sw124 &#128527 </a></p>
	  </div>
